...
/// <summary>
/// A set of extension methods for types implement <see cref="IBaseContainer"/> and <see cref="IChatIdExtractable"/>. 
/// </summary>
public static class ChatContainerExtensions
{
    ...
    public static async Task<IBaseContainer<Message>> SendChatMessage<C>(
        ...
        where C: IBaseContainer, IChatIdExtractable
    {
        return await simpleContext.BotClient.SendMessage(
            chatId: simpleContext.GetEnsuredChatId(),
            text: text,
            parseMode: parseMode,
