...
/// <summary>
/// Abstract scoped controller handler for <see cref="UpdateType.CallbackQuery"/>.
/// </summary>
/// <remarks>
/// Set handling priority of this handler.
/// </remarks>
public abstract class CallbackQueryControllerHandler()
    : AbstractControllerUpdateHandler<CallbackQuery, CallbackQueryContainer>(x => x.CallbackQuery)
{
    /// <inheritdoc/>
