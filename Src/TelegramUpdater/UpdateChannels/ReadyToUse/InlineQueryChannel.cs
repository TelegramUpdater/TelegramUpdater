...
public class InlineQueryChannel(TimeSpan timeOut, IFilter<UpdaterFilterInputs<InlineQuery>>? filter)
    : DefaultChannel<InlineQuery>(UpdateType.InlineQuery, timeOut, x => x.InlineQuery, filter)
{
}
