...
public sealed class MyChatMemberChannel(TimeSpan timeOut, IFilter<UpdaterFilterInputs<ChatMemberUpdated>>? filter)
    : DefaultChannel<ChatMemberUpdated>(UpdateType.MyChatMember, x => x.MyChatMember, timeOut, filter)
{
}
