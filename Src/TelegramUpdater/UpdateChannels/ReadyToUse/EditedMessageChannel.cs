...
public sealed class EditedMessageChannel(TimeSpan timeOut, IFilter<Message>? filter)
    : AnyChannel<Message>(UpdateType.EditedMessage, x => x.EditedMessage, timeOut, filter)
{
}
