...
public sealed class PreCheckoutQueryChannel(TimeSpan timeOut, IFilter<PreCheckoutQuery>? filter)
    : AnyChannel<PreCheckoutQuery>(UpdateType.PreCheckoutQuery, x=> x.PreCheckoutQuery, timeOut, filter)
{
}
