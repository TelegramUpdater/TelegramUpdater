...
public class MessageChannel(TimeSpan timeOut, IFilter<UpdaterFilterInputs<Message>>? filter = default)
    : DefaultChannel<Message>(UpdateType.Message, timeOut, x => x.Message, filter)
{
}
