...
public sealed class ChannelPostChannel(TimeSpan timeOut, IFilter<UpdaterFilterInputs<Message>>? filter)
    : DefaultChannel<Message>(UpdateType.ChannelPost, timeOut, x => x.ChannelPost, filter)
{
}
