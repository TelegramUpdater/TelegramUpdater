...
public sealed class ShippingQueryChannel(TimeSpan timeOut, IFilter<ShippingQuery>? filter)
    : AnyChannel<ShippingQuery>(UpdateType.ShippingQuery, x=> x.ShippingQuery, timeOut, filter)
{
}
